...
- [ ] Зафиксировать инвариант «одна активная shipment-попытка на заказ».
- [ ] Устранить риск дубликатов при конкурентных job retries.
- [ ] Добавить конкурентные тесты на dispatch flow.
