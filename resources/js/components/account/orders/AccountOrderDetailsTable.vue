<template>
    <AppGridTwoColumns>
        <AppDetailBox title="Billing address" :content="formatAddress(order.billing_address)" />
        <AppDetailBox title="Shipping address" :content="formatAddress(order.shipping_address)" />
    </AppGridTwoColumns>
