<template>
    <div class="card">
        ...
        <div class="actions actions--top">
            <input v-model="searchQuery" placeholder="Search by campaign or code" :disabled="isLoading" />
        ...
        <div class="table-wrap actions--top">
            <table class="table">
                ...
                >
                    ...
                    <td>
                        <span class="status-chip" :class="promotion.is_active ? 'status-chip--good' : 'status-chip--neutral'">
                    ...
                    <td>
                        <div class="actions">
                            <button class="btn btn-muted" type="button" @click="$emit('select', promotion.id)">
                                Coupons
                            </button>
                            <button class="btn btn-muted" type="button" @click="$emit('edit', promotion)">
                                Edit
                            </button>
                            <button
                                class="btn btn-muted"
                ...
                <tr>
                    <td colspan="6">
                        <div class="empty-state">
                            <p>{{ isLoading ? 'Loading campaigns...' : 'No campaigns found.' }}</p>
                        </div>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="actions actions--top">
            <button class="btn btn-muted" type="button" :disabled="page <= 1 || isLoading" @click="$emit('loadPrev')">
                Previous
            </button>
            <button class="btn btn-muted" type="button" :disabled="page >= meta.last_page || isLoading" @click="$emit('loadNext')">
                Next
            </button>
        </div>
    </div>
