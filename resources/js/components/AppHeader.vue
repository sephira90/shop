        ...
        <div class="container app-header__inner">
            ...
            <div class="app-header__actions">
                <nav class="app-nav" aria-label="Main navigation">
                    ...
                    <RouterLink v-if="canAccessAccount" to="/account/profile" class="app-nav__link">Account</RouterLink>
                    <RouterLink v-if="canAccessAdmin" to="/admin" class="app-nav__link">Admin</RouterLink>
                    <RouterLink v-if="!authStore.isAuthenticated" to="/auth" class="app-nav__link">Sign in</RouterLink>
                </nav>
                <button
                    ...
                    @click="toggleTheme"
                >
                    <span class="theme-toggle__icon" aria-hidden="true">{{ theme === 'dark' ? 'D' : 'L' }}</span>
                    <span>{{ theme === 'dark' ? 'Dark' : 'Light' }}</span>
                </button>
                <button v-if="authStore.isAuthenticated" class="btn btn-muted" type="button" @click="logout">
                    Logout
                </button>
            </div>
        </div>
