    ...
    <section class="grid">
        ...
        <div class="card">
            <div class="stack stack--between">
                ...
                <button class="btn btn-muted" type="button" :disabled="isLoading" @click="loadCategories(page)">
                    Refresh
                </button>
            </div>

            <div class="actions actions--top">
                <input v-model="searchQuery" placeholder="Filter by name, slug or parent" :disabled="isLoading" />
            ...
            <div class="table-wrap actions--top">
                <table class="table">
                    ...
                    <tr v-for="category in filteredCategories" :key="category.id">
                        ...
                        <td>
                            <div class="actions">
                                <button class="btn btn-muted" type="button" @click="startEdit(category)">
                                    Edit
                                </button>
                                <button
                                    class="btn btn-muted"
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="empty-state">
                                <p>{{ isLoading ? 'Loading categories...' : 'No categories on this page.' }}</p>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <div class="stack stack--between actions--top">
                <p class="muted">
                    Page {{ meta.current_page }} of {{ meta.last_page }}. Total categories: {{ meta.total }}.
                </p>
                <div class="actions">
                    <button class="btn btn-muted" type="button" :disabled="page <= 1 || isLoading" @click="loadCategories(page - 1)">
                        Previous
                    </button>
                    <button
                        class="btn btn-muted"
